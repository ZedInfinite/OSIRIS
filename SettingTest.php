...
<?php
/*
Plugin Name: OSIRIS Setting Plugin
Plugin URI:
...
{
	add_menu_page("Setting Test", "Test Dashboard", 4, "Test", "Test_Dashboard");
	add_submenu_page("Test", "SettingSub", "Setting", 4, "Setting", "Plugin_Setting_Content");
}

// Content for the main page of OSIRIS plugin
function Test_Dashboard()
{
	?> <h1>Test Setting Plugin</h1> <?php
}
...
{
    add_settings_field( 'our_first_field', 'Field Name', 'field1_callback' , 'Setting', 'our_first_section' );
}
...
function field1_callback($arguments)
{
    ...
    register_setting( 'Setting', 'our_first_field' );
}
?>
</html>
*/
